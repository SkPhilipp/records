...
def test_records_demo():
    ...
    gym1 = records.gym(name="Fight Club Amsterdam", location="Amsterdam", travel_time=25)
    gym2 = records.gym(name="Boxing Gym Central", location="Amsterdam", travel_time=35)
    gym3 = records.gym(name="Heavy Bag Training", location="Amsterdam", travel_time=15)
